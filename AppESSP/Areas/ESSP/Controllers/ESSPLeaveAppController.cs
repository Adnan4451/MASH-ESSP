...
namespace AppESSP.Areas.ESSP.Controllers
{
    public class ESSPLeaveAppController : Controller
    {
        ...
        public ActionResult ApprovedAll(int?[] SelectedLvAppIds)
        {
            VMLoggedUser LoggedInUser = Session["LoggedInUser"] as VMLoggedUser;
            string Message = "";
            foreach (var item in SelectedLvAppIds)
            {
                ...
                Message = ESSPLeaveService.ApproveLeaveApplication(vmESSPCommon, LoggedInUser,Message);
        ...
        private void HelperMethod(LeaveApplication obj)
        {
            ...
            ViewBag.LeaveTypeID = new SelectList(DDService.GetLeaveType().ToList().Where(aa => aa.PLeaveTypeID != 2 && aa.PLeaveTypeID != 5 && aa.PLeaveTypeID != 6 && aa.PLeaveTypeID != 7 && aa.PLeaveTypeID != 8 && aa.PLeaveTypeID != 9 && aa.PLeaveTypeID != 10).ToList(), "PLeaveTypeID", "LeaveTypeName", obj.LeaveTypeID);
