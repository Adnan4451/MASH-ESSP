...
namespace ESSPSERVICE.ESSP
{
    public static class ESSPText
    {
        ...
        public static string GetPendingLeaveText(VAT_LeaveApplication vlvapplication, string ToName)
        {
            ...
            Body = Body + "<br/>You can access the ESSP account through following link: <br/>" + "http://bcl-portal/";
            Body = Body + "<br/><br/><p>***This is System generated email. Please do not reply.***</p><p>Please print this email only if necessary. Go Green </p><p>Thank You!</p>" + "</body>";
            return Body;
        }
