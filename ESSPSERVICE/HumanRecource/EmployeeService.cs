...
namespace ESSPSERVICE.HumanRecource
{
    ...
    public class EmployeeService : IEmployeeService
    {
        ...
        public VMEmployee GetEdit(int id)
        {
            ...
            vmEmployee.DepartmentID = (int)employeeObj.OUID;
            vmEmployee.DesigationID = (int)employeeObj.DesigationID;
            vmEmployee.LocationID = employeeObj.LocationID;
            ...
            vmEmployee.CPLPolicyID = employeeObj.STDLPolicyID;
        ...
        public void PostCreate(VMEmployee obj, VMLoggedUser LoggedInUser)
        {
            ...
            employeeObj.JobTitleID = 1;
            employeeObj.GradeID = 1;
            employeeObj.OUID = obj.DepartmentID;
            employeeObj.LocationID = obj.LocationID;
        ...
        public void PostEdit(VMEmployee obj, VMLoggedUser LoggedInUser)
        {
            ...
            employeeObj.STDLPolicyID = obj.CPLPolicyID;
